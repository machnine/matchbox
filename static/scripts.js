...
//
// Normalisation is done server-side via /normalise/ so the rules live in one
// place rather than being duplicated as regexes here. The server handles more
// forms than this function used to (HLA- prefixes, colon-form alleles such as
// DRB1*04:01, leading zeros) and returns suggestions for anything it cannot
// match.
